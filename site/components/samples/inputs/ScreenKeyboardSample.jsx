        ...
        return (
            <span>
                <div style={{marginBottom:230}}>
                    <Label>{Application.i18n(ScreenKeyboardSample, "inputs.ScreenKeyboardSample", "keyboardOne")}</Label>
                    <TextInput
                ...
                <div style={{marginBottom:200}}>
                    <Label>{Application.i18n(ScreenKeyboardSample, "inputs.ScreenKeyboardSample", "keyboardTwo")}</Label>
                    <NumericInput
                ...
                <div style={{marginBottom:230}}>
                    <Label>{Application.i18n(ScreenKeyboardSample, "inputs.ScreenKeyboardSample", "keyboardThree")}</Label><br/>
                    <span>{Application.i18n(ScreenKeyboardSample, "inputs.ScreenKeyboardSample", "clickedKey")}</span>
                    <Label>{this.state.screenKeyboardDefault}</Label>
