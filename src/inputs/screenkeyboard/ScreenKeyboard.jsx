...
export default class ScreenKeyboard extends ShallowComponent {
    ...
    __renderQKeyboard() {
        ...
        for (let i = 0; i < keySet.length; i++) {
            ...
            if (key.key === "14")
                buttonSetArray.push(<Button key={i} size="sm" className="buttons backspaceButton"
                                            onClick={this.__handleBackspaceClick}><FaIcon
                    code="fa-long-arrow-left"/></Button>);
            else if (key.key === "15")
                buttonSetArray.push(<Button name="q" data={value} key={i} size="sm" className="buttons qButton"
                                            onClick={this.__handleButtonClick}>{value}</Button>);
            else if (key.key === "28")
                buttonSetArray.push(<Button key={i} size="sm" className="buttons capsLockButton"
                                            onClick={this.__handleCapsLockClick}><FaIcon
                    code="fa-chevron-up"/></Button>);
            else if (key.key === "40")
                buttonSetArray.push(<Button key={i} size="sm" className="buttons shiftButton"
                                            onClick={this.__handleShiftClick}>{value}</Button>);
            else if (key.key === "51")
                buttonSetArray.push(<Button key={i} size="sm" className="rightShiftButton"
                                            onClick={this.__handleShiftClick}>{value}</Button>);
            else if (key.key === "52" || key.key === "54")
                buttonSetArray.push(<Button key={i} size="sm" className="buttons"
                                            onClick={this.__handleControlClick}>{value}</Button>);
            else if (key.key === "53")
                buttonSetArray.push(<Button name="space" data={value} key={i} size="sm"
                                            className="buttons spaceButton"
                                            onClick={this.__handleButtonClick}>{value}</Button>);
            else
                buttonSetArray.push(<Button name={i + "key" + i} data={value} key={i} size="sm" className={className}
                                            onClick={this.__handleButtonClick}>{value}</Button>);
        }
    ...
    __renderDigitalKeyboard() {
        ...
        for (let i = 0; i < keySet.length; i++) {
            ...
            if (key.key === "14")
                buttonSetArray.push(<Button key="backspace" size="sm" className={className}
                                            onClick={this.__handleBackspaceClick}><FaIcon
                    code="fa-long-arrow-left"/></Button>);
            else {
                ...
                buttonSetArray.push(<Button name={i + "decNum" + i} data={key.value} key={i} size="sm"
