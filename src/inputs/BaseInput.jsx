...
import { FormGroup, InputGroup, Label, FormControl, OverlayTrigger, Tooltip, Input } from "reactstrap";
...
export default class BaseInput extends ValidationComponent {
    ...
    render(): Object {
        ...
        let component = (
            <Input {...newProps} ref={(component: Object) => { this.innerComponent = component }}   value={this.props.value} />
        );
        ...
        component = (
            <FormGroup hidden={this.props.hidden} size={this.props.size}>
                {label}
                {component}
            </FormGroup>
        );
