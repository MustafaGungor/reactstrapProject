...
import {Popover, Overlay, Tooltip, Col} from "reactstrap";
import "./Slider.css";
...
export default class Slider extends ShallowComponent {
    ...
    render():Object {
        ...
        if (!this.props.closeTooltip && this.circleMaxDOM != undefined && this.circleMinDOM != undefined){
            let sliderTooltip = (
                <span>
                    <Tooltip isOpen={this.state.openMaxDesc} placement="top" target={this.circleMaxDOM.id} toggle={this.toggleMax}>{this.state.valueMax + " " + this.state.unit}</Tooltip>
                    <Tooltip isOpen={this.state.openMinDesc} placement="top" target={this.circleMinDOM.id} toggle={this.toggleMin}>{this.state.valueMin + " " + this.state.unit}</Tooltip>
                </span>
            );
        }
        ...
        return (<span>
            ...
            <span ref={this.selectedDivRef} id={this.selectedDivRef} className={classNameSelected}
                 style={{left: styleLeft, width: styleWidth}}
                 onClick={!this.state.disabled ? this.__layerClick : null}/>
            <span ref={this.layerDivRef} id={this.layerDivRef} className={classNameLayer}
                 onClick={!this.state.disabled ? this.__layerClick : null}/>
            <span ref={this.circleDivMaxRef} id={this.circleDivMaxRef} className={classNameCircle}
                 style={{left: parseFloat(this.state.defaultMaxPx)}} >
            </span>
                {this.props.range ?
                    <span ref={this.circleDivMinRef} id={this.circleDivMinRef} className={classNameCircleMin}
