...
export default class ModalDataForm extends ShallowComponent {
    ...
    render(): Object {
        return (
            <Modal isOpen={this.state.show} className={this.props.className} toggle={this.props.onCancel}>
    ...
    __renderFooterButtons = (): ModalFooter => {
        ...
        let showSaveButton = ((this.props.showSaveButton) ?
            <Button color="primary" ref={(component: Object) => { this.__submitButtonComponent = component; } } onClickAsync={this.__submitForm}>{this.props.ok}</Button> : null);
    ...
    __renderWarning = (): Alert => {
        ...
        return (<Alert color="danger" className="input-alert">{errors}</Alert>);
    };
